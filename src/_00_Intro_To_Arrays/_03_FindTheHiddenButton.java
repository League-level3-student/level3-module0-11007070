...
public class _03_FindTheHiddenButton implements ActionListener{
    ...
    public void start() throws InterruptedException {
        ...
        String posInt = JOptionPane.showInputDialog("Enter a positive # for the amount of buttons you want in the game:");
        int numButtons = Integer.parseInt(posInt);
        ...
        JOptionPane.showMessageDialog(null, "Instructions: click on the hidden button that flashes");

        // 13. initialize the hiddenButton variable to a random number less than
        //     the int created in step 3
        Random ran = new Random();
        hiddenButton = ran.nextInt(numButtons);
